...
impl fmt::Display for NodeSortField {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let label = match self {
            ...
            NodeSortField::BinaryVersion => "Version",
...
impl NodesSortStrategy {
    ...
    pub fn variants() -> Vec<Self> {
        vec![
            ...
            Self::new(NodeSortField::BinaryVersion, true),
            Self::new(NodeSortField::BinaryVersion, false),
    ...
    pub fn from_arg_str(str: &str) -> Option<Self> {
        let strategy = match str {
            ...
            "version" => Self::new(NodeSortField::BinaryVersion, false),
            "version-desc" => Self::new(NodeSortField::BinaryVersion, true),
    ...
    pub fn as_arg_str<'a>(&self) -> &'a str {
        match (self.field, self.is_descending) {
            ...
            (NodeSortField::BinaryVersion, false) => "version",
            (NodeSortField::BinaryVersion, true) => "version-desc",
