...
pub fn AddNodesForm(modal_visibility: RwSignal<bool>) -> impl IntoView {
    ...
    view! {
        ...
        <div class="p-4 md:p-5">
            <AddNodeTabs modal_visibility active_tab />
        </div>
    }
}

#[component]
fn AddNodeTabs(modal_visibility: RwSignal<bool>, active_tab: RwSignal<u8>) -> impl IntoView {
    ...
    view! {
        ...
        >
            {move || {
                ...
                if count > 1 { format!("Add {count} nodes") } else { "Add single node".to_string() }
            }}
        </button>
    }
}
